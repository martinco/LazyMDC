...
<html>
  <head>
    ...
    <link rel="stylesheet" href="<?php echo $kneeboard_root ?>../index.css">
  ...
  <body>
    <div id="loader-container">
      <div id="loader">
      <img src="<?php echo $kneeboard_root ?>../img/loader.svg" style="width:30px; height:30px"></img>
      </div>
    </div>
    ...
    <div id="main-page" style="width: 1250px; margin: 0 auto; min-height: 100%; display: flex">
      ...
      <!-- Main Page -->
      <div class="tab-content" style="float: left; width:1050px; min-height: 100%; padding: 15px; border-right:1px solid #dfdfdf; padding-top:58px">
        <?php
        readfile('pages/login.html');
        readfile('pages/introduction.html');
        readfile('pages/theatres.html');
        readfile('pages/squadrons.html');
        readfile('pages/threats.html');
        readfile('../modals/coords.html');
        readfile('modals/common.html');
        ?>
        </div>
      </div>
    ...
    <script type="text/javascript" src="<?php echo $kneeboard_root ?>../js/zip-js/zip.js"></script>
