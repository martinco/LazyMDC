...
INSERT INTO `permissions` VALUES (1,'users-view','View user accounts'),(2,'users-create','Create user accounts'),(3,'squadrons-create','Create squadrons'),(4,'theatre-create','Manage Theatres');
...
CREATE TABLE `user_permissions` (
  ...
  CONSTRAINT `user_permissions_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `users` (`idx`) ON DELETE CASCADE,
  CONSTRAINT `user_permissions_ibfk_2` FOREIGN KEY (`permission_id`) REFERENCES `permissions` (`idx`) ON DELETE CASCADE
...
INSERT INTO `user_permissions` VALUES (1,1,1),(2,1,2),(3,1,3),(4,1,4);
